...
class ActionTab(ttk.Frame):
    def __init__(self, main_window):
        ...
        self.frame_addword = ttk.LabelFrame(self, text='Add word to dictionary')
        ...
        self.main_window.var['add']['simplified'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.entry_addword_simplified = ttk.Entry(this_frame_2, textvariable=self.main_window.var['add']['simplified'], width=10)
        ...
        self.main_window.var['add']['pinyin'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.entry_addword_pinyin = ttk.Entry(this_frame_2, textvariable=self.main_window.var['add']['pinyin'], width=30)
        ...
        self.main_window.var['add']['traditional'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.entry_addword_traditional = ttk.Entry(this_frame_2, textvariable=self.main_window.var['add']['traditional'], width=10)
        ...
        self.main_window.var['add']['hsk'] = tk.IntVar(value=0)
        r_grid_2 += 0; c_grid_2 += 1
        self.entry_addword_hsk = ttk.Entry(this_frame_2, textvariable=self.main_window.var['add']['hsk'], width=5)
        ...
        self.main_window.var['add']['definition'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.entry_addword_definition = ttk.Entry(this_frame_2, textvariable=self.main_window.var['add']['definition'])
        ...
        self.main_window.var['add']['example'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.entry_addword_example = ttk.Entry(this_frame_2, textvariable=self.main_window.var['add']['example'])
        ...
        self.main_window.var['add']['notes'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.entry_addword_notes = ttk.Entry(this_frame_2, textvariable=self.main_window.var['add']['notes'])
        ...
        self.main_window.var['add']['checkresults'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.label_addword_checkresults = ttk.Label(this_frame_2, textvariable=self.main_window.var['add']['checkresults'])
        ...
        self.main_window.var['add']['addresults'] = tk.StringVar(value='')
        r_grid_2 += 0; c_grid_2 += 1
        self.label_addword_addresults = ttk.Label(this_frame_2, textvariable=self.main_window.var['add']['addresults'])
        ...
        r_grid_1 = -1; c_grid_1 = -1
        self.frame_editword = ttk.LabelFrame(self, text='Edit word')
        this_frame_1 = self.frame_editword
        this_frame_1.grid(row=r_grid_0, column=c_grid_0, sticky='NESW')
        self.rowconfigure(r_grid_0, weight=1)
        # self.columnconfigure(c_grid_0, weight=1)

        self.main_window.var['edit'] = dict()
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['searchword'] = tk.StringVar(value='')
        self.entry_searchword = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['searchword'], width=20)
        ...
        r_grid_2 += 1; c_grid_2 += 1
        self.main_window.var['edit']['searchresults'] = tk.StringVar(value='')
        self.label_searchword_results = ttk.Label(this_frame_2, textvariable=self.main_window.var['edit']['searchresults'])
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['simplified'] = tk.StringVar(value='')
        self.entry_editword_simplified = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['simplified'], width=10)
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['pinyin'] = tk.StringVar(value='')
        self.entry_editword_pinyin = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['pinyin'], width=30)
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['traditional'] = tk.StringVar(value='')
        self.entry_editword_traditional = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['traditional'], width=10)
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['hsk'] = tk.IntVar(value=0)
        self.entry_editword_hsk = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['hsk'], width=5)
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['definition'] = tk.StringVar(value='')
        self.entry_editword_definition = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['definition'])
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['example'] = tk.StringVar(value='')
        self.entry_editword_example = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['example'])
        ...
        r_grid_2 += 0; c_grid_2 += 1
        self.main_window.var['edit']['notes'] = tk.StringVar(value='')
        self.entry_editword_notes = ttk.Entry(this_frame_2, textvariable=self.main_window.var['edit']['notes'])
        ...
        r_grid_0 += 1; c_grid_0 += 0
        r_grid_1 = -1; c_grid_1 = -1
        self.frame_uploadchanges = ttk.LabelFrame(self, text='Upload changes')
    ...
    def _callback_button_addword_check(self):
        word = self.main_window.var['add']['simplified'].get().strip()
        print('word:',word)

        if not word:
            self.main_window.var['add']['checkresults'].set("Enter a word first.")
            return

        result = self.app.find_word(word)

        if result is None:
            self.main_window.var['add']['checkresults'].set("Word not found. You may add it.")
        else:
            self.main_window.var['add']['checkresults'].set("Word already exists.")
    ...
    def _callback_button_addword_add(self):
        data = {
            "simplified": self.main_window.var['add']['simplified'].get().strip(),
            "pinyin": self.main_window.var['add']['pinyin'].get().strip(),
            "traditional": self.main_window.var['add']['traditional'].get().strip(),
            "hsk": self.main_window.var['add']['hsk'].get(),
            "definition": self.main_window.var['add']['definition'].get().strip(),
            "example": self.main_window.var['add']['example'].get().strip(),
            "notes": self.main_window.var['add']['notes'].get().strip(),
        }

        if not data["simplified"]:
            self.main_window.var['add']['addresults'].set("Word cannot be empty.")
            return

        result = self.app.add_word(data)

        if result is None:
            self.main_window.var['add']['addresults'].set("Failed to add word.")
        else:
            self.main_window.var['add']['addresults'].set("Word added successfully.")

    
    def _callback_button_searchword(self):
        word = self.main_window.var['edit']['searchword'].get().strip()

        if not word:
            self.main_window.var['edit']['searchresults'].set("Enter a word to search.")
            return

        result = self.app.find_word(word)

        if result is None:
            self.main_window.var['edit']['searchresults'].set("Word not found.")
            return

        # Populate edit fields
        self.main_window.var['add']['simplified'].set(result["simplified"])
        self.main_window.var['add']['pinyin'].set(result["pinyin"])
        self.main_window.var['add']['traditional'].set(result["traditional"])
        self.main_window.var['add']['hsk'].set(result["hsk"])
        self.main_window.var['add']['definition'].set(result["definition"])
        self.main_window.var['add']['example'].set(result["example"])
        self.main_window.var['add']['notes'].set(result["notes"])

        self.main_window.var['edit']['searchresults'].set("Word loaded for editing.")
